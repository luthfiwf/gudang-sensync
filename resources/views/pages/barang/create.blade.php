                    ...
                    <div class="card-body">
                      <form action="{{route('barang.store')}}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="number" class="form-control" name="stock" placeholder="Stok Barang" value="{{old('stock')}}"/>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="rak" placeholder="Penyimpanan" value="{{old('rak')}}">
